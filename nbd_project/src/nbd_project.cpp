...
/******************************************************************************
                                   C'tors                   
******************************************************************************/
BDproxy::BDproxy(const char* dev_file, size_t dev_size, const char* stor_file_path, const char* monitor_path)
: m_dev_file(dev_file),m_conected_status(true),
  m_storage_file(stor_file_path, dev_size), m_monitor_path(monitor_path)
{   
